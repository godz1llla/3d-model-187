...
async function loadObjectImages(objectId) {
    ...
    const objectImages = {
        ...
        16: [], // Памятник «Коркыт Ата»
        17: [], // Мемориал «Вечная слава»
        18: [], // Монумент «Сыр Ана»
        19: [], // Дом культуры имени Аскара Токмаганбетова
        20: [], // Дом культуры имени Сабиры Майкановой
        21: [],  // Центр «Рухани жаңғыру»
        22: [],   // Дом дружбы
        23: [],   // Стадион
        24: [],   // Памятник «Батыры Сыр бойы»
        25: [],   // Музей «Акмешит»
        26: [],   // НИШ ХБН г. Кызылорда
        27: [],   // Евразия КСК
        28: [],   // Ледовый дворец
        29: [],   // Областная художественная галерея
        30: []    // Дом культуры имени Мадины Ералиевой
    };
